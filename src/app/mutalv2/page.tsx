...
import FormRender from '../components/form/formrender/FormRender';
                ...
                <div className='grid grid-cols-2 h-full'>
                    ...
                    <div className='flex justify-center items-center h-full'>
                        <div className='relative'>
                            ...
                            {/* <div className='xl:hidden 2xl:block ml-10 absolute max-w-[] w-full'>
                                <FormRender />
                            </div> */}
                    ...
                    <div className="relative h-full">
                        <div className="fullrotate absolute top-0 bottom-0 -right-95 -mt-140 bg-white h-[1950px] w-[700px] z-0"></div>
                        ...
                        <div className="absolute right-10 inset-0 z-10 w-ft h-screen">
                            ...
                            <div className='relative'>
                                <div className='h-screen absolute w-25 fullrotate xl:right-80 2xl:right-66 top-0 p-4'>
                                    ...
                                    <div className='w-full h-75 rounded-2xl -mt-60'>
                                        <Image
                            ...
                            <div
                                className="w-80 h-38  absolute xl:right-96 2xl:xl:right-100 top-0 rounded-br-2xl hover:scale-110 transition-all duration-300 cursor-pointer"
                                style={{ clipPath: 'polygon(50% 100%, 0% 0%, 100% 0%)' }}
