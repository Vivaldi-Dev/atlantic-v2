...
export default function Voo() {
    ...
    const onSubmit = (data: FormValues) => {
        ...
        router.push(`/voos?request=${encodeURIComponent(JSON.stringify(request))}`);
    };

    return (
        <form onSubmit={handleSubmit(onSubmit)} className="grid grid-cols-1 md sm:grid-cols-4 items-start rounded-lg p-2 md:p-6 gap-5">
